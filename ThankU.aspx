<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="ThankU.aspx.cs" Inherits="ThankU" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" Runat="Server">
     <div class="Frm2">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FlowerDBTestConnectionString %>" SelectCommand="SELECT * FROM [tblFlowers] WHERE ([FlowerTypeId] = @FlowerTypeId)">
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="2" Name="FlowerTypeId" QueryStringField="FlowerTypeId" Type="Int32" />
            </SelectParameters>
         </asp:SqlDataSource>
    </div> 
</asp:Content>
