<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="Congratulation.aspx.cs" Inherits="Congratulation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" Runat="Server">
     <div class="Frm2">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FlowerDBTestConnectionString %>" SelectCommand="SELECT * FROM [tblFlowers] WHERE ([FlowerTypeId] = @FlowerTypeId)">
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="3" Name="FlowerTypeId" QueryStringField="FlowerTypeId" Type="Int32" />
            </SelectParameters>
         </asp:SqlDataSource>
    </div> </asp:Content>
